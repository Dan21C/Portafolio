...
public sealed class AuthServiceTests
{
    ...
    private sealed class FakeEmailSender : IEmailSender { public string? Code { get; private set; } public int SendCount { get; private set; } public Task SendOtpAsync(string email, string code, DateTimeOffset expiresAt, CancellationToken ct) { Code = code; SendCount++; return Task.CompletedTask; } }
